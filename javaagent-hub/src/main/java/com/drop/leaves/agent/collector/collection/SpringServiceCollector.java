...
public class SpringServiceCollector extends AbstractCollector implements Collector {
    ...
    static {
        ...
        sbuilder.append("com.drop.leaves.agent.collector.collects.SpringServiceCollects instance= ");
        sbuilder.append("com.drop.leaves.agent.collector.collects.SpringServiceCollects.INSTANCE;\r\n");
        sbuilder.append("com.drop.leaves.agent.collector.init.AbstractCollects.Statistics statistic =instance.begin(\"%s\",\"%s\");");
