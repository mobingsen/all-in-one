package org.tea.plus.agent.httpservlet;
...
public class AgentMain implements ClassFileTransformer {
    ...
    private byte[] buildClass(String target, ClassLoader loader) throws NotFoundException, CannotCompileException, IOException {
        ...
        method.insertBefore("org.tea.plus.agent.httpservlet.DispatcherServletCollect.begin($args, $args)");
        pool.get("org.tea.plus.agent.httpservlet.DispatcherServletCollect").toClass(loader);
