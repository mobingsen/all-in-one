...
import org.tea.plus.agent.collector.init.AbstractCollector;
import org.tea.plus.agent.collector.init.AgentLoader;
import org.tea.plus.agent.collector.init.Collector;
...
public class SpringServiceCollector extends AbstractCollector implements Collector {
    ...
    static {
        ...
        sbuilder.append("org.tea.plus.agent.collector.collects.SpringServiceCollects instance= ");
        sbuilder.append("org.tea.plus.agent.collector.collects.SpringServiceCollects.INSTANCE;\r\n");
        sbuilder.append("org.tea.plus.agent.collector.init.AbstractCollects.Statistics statistic =instance.begin(\"%s\",\"%s\");");
